    ...
    <div className="p-4 sm:p-6 max-w-2xl">
      ...
      <div className="space-y-6">
        <div className="bg-card rounded-2xl border border-border p-6">
          ...
          <div><Label>Store Name</Label><Input value={form.store_name} onChange={e => set('store_name', e.target.value)} placeholder="BlazeBites" className="mt-1.5" /></div>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border p-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            <div className="col-span-2 sm:col-span-1"><Label>Free Over ($)</Label><Input type="number" value={form.delivery_free_threshold} onChange={e => set('delivery_free_threshold', e.target.value)} className="mt-1.5" /></div>
          </div>
